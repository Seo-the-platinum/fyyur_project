...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.new_question={
            'question':'''What NBA player wears number 30
    ...
    def test_failed_to_add(self):
        res = self.client().post('/questions/73', json=self.new_question)
        data= json.loads(res.data)
        self.assertEqual(res.status_code, 405)
        self.assertEqual(data['success'], False)
        self.assertEqual(data['message'], 'Method Not Allowed')
    ...
    def test_failed_get_by_cat(self):
